...
# function to do the computation. The function should return a
# value. Use 45 hours and a rate of 10.50 per hour to test the
# program (the pay should be 498.75). You should use input to read
# a string and float() to convert the string to a number. Do not
# worry about error checking the user input unless you want to -
...
def computepay(hours, rate):
    if hours <= 40:
        ...
        return (40 * rate) + ((hours - 40) * rate) * 1.50
